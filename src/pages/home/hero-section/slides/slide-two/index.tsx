...
const SlideTwo = () => {
  return (
    <div
      className={`bg-[url('/banner/2.jpg')] bg-center h-screen lg:bg-top bg-cover bg-no-repeat relative overflow-hidden min-w-full`}
    >
      <div className="container">
        <div className="py-4 lg:py-10">
          ...
          <div className="flex justify-between items-center w-full h-screen">
            ...
            <button className="w-44 h-8 bg-[#1677FF] rounded-full lg:mt-44"></button>
          </div>
        </div>
      </div>
    </div>
